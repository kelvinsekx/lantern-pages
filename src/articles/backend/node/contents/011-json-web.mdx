---
title: "The Essentials on JWTs, Access & Refresh Tokens"
...
The client application receives the token and must store it (e.g., in localStorage). For every protected API call, the client explicitly sets the Authorization header with the Bearer Token.
