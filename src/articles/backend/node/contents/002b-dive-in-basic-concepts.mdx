...
This module may feel way longer compared to previously completed ones. Please don't rush it. These are the basic concepts that the complex parts are built on.
